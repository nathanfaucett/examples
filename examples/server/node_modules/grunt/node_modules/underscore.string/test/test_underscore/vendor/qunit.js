...
(function(window) {
    ...
    function done() {
        ...
        var banner = id("qunit-banner"),
            tests = id("qunit-tests"),
            html = ['Tests completed in ', +new Date - config.started, ' milliseconds.<br/>',
    ...
    QUnit.jsDump = (function() {
        ...
        var jsDump = {
            ...
            typeOf: function(obj) {
                ...
                return type != 'object' && type != f ? type : !obj ? 'null' :
...
(function(window) {
    ...
    function done() {
        ...
        var banner = id("qunit-banner"),
            tests = id("qunit-tests"),
            html = ['Tests completed in ', +new Date - config.started, ' milliseconds.<br/>',
                '<span class="passed">', config.stats.all - config.stats.bad, '</span> tests of <span class="total">', config.stats.all, '</span> passed, <span class="failed">', config.stats.bad, '</span> failed.'
            ].join('');
