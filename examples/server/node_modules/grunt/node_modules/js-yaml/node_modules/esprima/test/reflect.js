    ...
    function testReflect(Reflect, Pattern) {
        ...
        program([exprStmt(ident("f")),
            ifStmt(lit(1),
                ...
                null)
        ]).assert(Reflect.parse("f; if (1) function f(){}"));
        ...
        assertStmt("switch (foo) { case 1: 1; break; case 2: 2; break; default: 3; }",
            switchStmt(ident("foo"), [caseClause(lit(1), [exprStmt(lit(1)), breakStmt(null)]),
        ...
        assertStmt("try { } catch (e) { }",
            tryStmt(blockStmt([]), [], [catchClause(ident("e"), null, blockStmt([]))],
                null));
