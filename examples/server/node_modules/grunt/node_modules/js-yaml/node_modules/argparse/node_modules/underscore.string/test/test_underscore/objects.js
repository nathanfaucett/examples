$(document).ready(function() {
    ...
    test("keys", function() {
        equal(_.keys({
            one: 1,
            two: 2
        }).join(', '), 'one, two', 'can extract the keys from an object');
    ...
    test("values", function() {
        equal(_.values({
            one: 1,
            two: 2
        }).join(', '), '1, 2', 'can extract the values from an object');
        equal(_.values({
            one: 1,
            two: 2,
            length: 3
        }).join(', '), '1, 2, 3', '... even when one of them is "length"');
    });
    ...
    test("pick", function() {
        ...
        ok(_.isEqual(_.pick(new Obj, 'a', 'c'), {
            a: 1,
            c: 3
    ...
    test("isEqual", function() {
        ...
        equal(_({
            ...
            x: 1,
            y: 2
        }).chain()).value(), true, '`isEqual` can be chained');
