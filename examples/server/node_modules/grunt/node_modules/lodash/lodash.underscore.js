...
(function(window, undefined) {
    ...
    var forIn = function(collection, callback) {
        var index, value, iteratee = collection,
            result = collection;
    ...
    function clone(value) {
        return value && objectTypes[typeof value] ? (isArray(value) ? slice.call(value) : extend({}, value)) : value
    }
    ...
    var defaults = function(object) {
        var index, value, iteratee = object,
            result = object;
    ...
    function contains(collection, target) {
        ...
        return typeof length == 'number' ? indexOf(collection, target) > -1 : some(collection, function(value) {
            return value === target;
        });
    }
    ...
    function toArray(collection) {
        if (collection && typeof collection.length == 'number') {
            return (typeof collection == 'string') ? collection.split('') : slice.call(collection);
        }
