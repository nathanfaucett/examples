...
(function(window, undefined) {
    ...
    function createBound(func, thisArg, partialArgs) {
        ...
        function bound() {
            ...
            if (partialArgs.length) {
                args = args.length ? partialArgs.concat(slice.call(args)) : partialArgs;
            }
    ...
    function clone(value, deep, guard, stackA, stackB) {
        ...
        if (!isObj || !deep) {
            ...
            return isObj ? (isArr ? slice.call(value) : extend({}, value)) : value;
        }
    ...
    var keys = !nativeKeys ? shimKeys : function(object) {
            ...
            return typeof object == 'function' && propertyIsEnumerable.call(object, 'prototype') ? shimKeys(object) : (isObject(object) ? nativeKeys(object) : []);
        };
            ...
            forOwn(args[index], function(source, key) {
                ...
                if (source && ((isArr = isArray(source)) || isPlainObject(source))) {
                    ...
                    if (found) {
                        ...
                        stackA.push(source);
                        stackB.push(value = (value = object[key], isArr) ? (isArray(value) ? value : []) : (isPlainObject(value) ? value : {}));
    ...
    function contains(collection, target, fromIndex) {
        ...
        if (typeof length == 'number') {
            return (isString(collection) ? collection.indexOf(target, fromIndex) : indexOf(collection, target, fromIndex)) > -1;
        }
    ...
    function reduceRight(collection, callback, accumulator, thisArg) {
        ...
        forEach(collection, function(value, index, collection) {
            ...
            accumulator = noaccum ? (noaccum = false, iteratee[index]) : callback.call(thisArg, accumulator, iteratee[index], index, collection);
        });
        return accumulator;
    }
    ...
    function initial(array, n, guard) {
        return array ? slice.call(array, 0, -((n == null || guard) ? 1 : n)) : [];
    }
    ...
    function rest(array, n, guard) {
        return array ? slice.call(array, (n == null || guard) ? 1 : n) : [];
    }
    ...
    function bind(func, thisArg) {
        ...
        return isBindFast || (nativeBind && arguments.length > 2) ? nativeBind.call.apply(nativeBind, arguments) : createBound(func, thisArg, slice.call(arguments, 2));
    }
    ...
    function template(text, data, options) {
        ...
        var reDelimiters = RegExp(
            ...
            (options.evaluate || settings.evaluate || reNoMatch).source + '|$', 'g');
