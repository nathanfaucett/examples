    ...
    function(EventEmitter, Device, Dom, util, Mathf, Color, Vec2, Vec4, Mat4, Enums, Log, Canvas) {
        ...
        function Renderer(opts) {
            ...
            this.init = function(canvas) {
                ...
                _spriteShader = createShader(sprite_vertex, sprite_fragment);
            ...
            function createShader(vertex, fragment) {
                ...
                parseUniformsAttributes(_gl, webglProgram, glVertexShader, glFragmentShader, shader.attributes, shader.uniforms);
            ...
            function bindBuffer(buffers, attributes) {
            ...
            function renderSprite(camera, transform2d, sprite2d) {
                ...
                bindBuffer(_spriteBuffers, _spriteShader.attributes);

                setUniformMatrix4fv(uniforms.matrix.location, MAT4, "matrix");
                setUniform4f(uniforms.crop.location, VEC4.set(sprite2d.x * w, sprite2d.y * h, sprite2d.w * w, sprite2d.h * h), "crop");
                setUniform2f(uniforms.size.location, VEC2.set(sprite2d.width, sprite2d.height), "size");
                setUniform1f(uniforms.alpha.location, sprite2d.alpha, "alpha");

                setTexture(uniforms.texture.location, texture, "texture");
